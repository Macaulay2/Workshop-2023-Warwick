...
realRootIsolation (RingElement,A) := List => (f,r)->(
	...
	L --list is ordered from smallest to largest interval, in case the while look stops after a larger interval
	) else (
	{}
	)
    )
...
document {
    	Key => {"Multiplicity(RealRootsOld)", [SylvesterCount, Multiplicity], [SturmCount, Multiplicity]},
...
restart
debug needsPackage "RealRootsOld"
needsPackage "RealRootsOld"
check "RealRootsOld"

uninstallPackage "RealRootsOld"
restart
installPackage "RealRootsOld"
viewHelp "RealRootsOld"
